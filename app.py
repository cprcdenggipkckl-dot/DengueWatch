...
if uploaded_file is not None:
    with st.spinner('Sedang memproses data...'):
        try:
            ...
            # Optional: Filter out coordinates that are clearly errors (outside Malaysia)
            ...
            # The exact HTML/JS code we built
            html_template = """
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div id="sidebar">
        ...
        <div class="control-group">
            ...
            <select id="visual-mode" onchange="updateMap()">
                ...
                <option value="dots_200">Dots + 200m Radius</option>
                <option value="dots_400">Dots + 400m Radius</option>
                <option value="dots_both">Dots + 200m & 400m</option>
            </select>
        </div>
        <div class="control-group">
    ...
    <script>
        ...
        function updateMap() {
            ...
            traces.push({ type: 'scattermapbox', mode: 'markers', lat: lats, lon: lons, marker: {size: 30, color: 'rgba(135, 206, 250, 0.4)'}, customdata: customdata, hovertemplate: hovertemplate, name: 'Radius 400m', visible: visualMode === 'dots_400' || visualMode === 'dots_both' });
            traces.push({ type: 'scattermapbox', mode: 'markers', lat: lats, lon: lons, marker: {size: 15, color: 'rgba(255, 69, 0, 0.5)'}, customdata: customdata, hovertemplate: hovertemplate, name: 'Radius 200m', visible: visualMode === 'dots_200' || visualMode === 'dots_both' });
            ...
            const layout = { title: titleText, mapbox: { style: mapStyle, center: {lat: avgLat, lon: avgLon}, zoom: 12.5 }, margin: {r: 0, t: 40, l: 0, b: 0}, showlegend: false, uirevision: 'true' };
